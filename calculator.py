# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 13:35:42 2020
...
if __name__ == "__main__": 
    ...
    gui.title("Nandini's Simple Calculator") 
  
    # set the configuration of GUI window 
    gui.geometry("265x230") 
    ...
    divide = Button(gui, text=' / ', fg='black', bg='blue', 
                    command=lambda: press("/"), height=1, width=18) 
    divide.grid(row=8, column=1) 
  
    equal = Button(gui, text=' = ', fg='black', bg='blue', 
                   command=equalpress, height=1, width=18) 
    equal.grid(row=9, column=0) 
  
    clear = Button(gui, text='Clear', fg='black', bg='blue', 
                   command=clear, height=1, width=18) 
